...
<tileset name="infmen" tilewidth="24" tileheight="32" tilecount="90" columns="18">
 <tileoffset x="-12" y="16"/>
 <properties>
  <property name="column_archer" type="int" value="12"/>
  <property name="column_hero" type="int" value="15"/>
 ...
 <image source="infmen.png" width="432" height="160"/>
 <tile id="0">
